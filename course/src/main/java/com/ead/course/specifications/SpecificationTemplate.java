...
public class SpecificationTemplate {
    ...
    public static Specification<ModuleModel> moduleCourseId(final UUID courseId) {
        return (root, query, cb) -> {
            ...
            Expression<Collection<ModuleModel>> coursesModule = course.get("modules");
            return cb.and(cb.equal(course.get("courseId"), courseId), cb.isMember(module, coursesModule));
        };
    }
